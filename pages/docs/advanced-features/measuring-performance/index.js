...
<p>
Чтобы измерить любую из поддерживаемых метрик, вам нужно будет создать настраиваемый компонент приложения и определить <span className="spanTag">reportWebVitals</span> функцию:
</p>
...
<p>
<span className="spanTag">metric</span> Объект возвращается к функции состоит из ряда свойств:
</p>
<p className="list">
 - <span className="spanTag">id</span>: Уникальный идентификатор показателя в контексте текущей загрузки страницы.
</p>
<p className="list">
 - <span className="spanTag">name</span>: Название метрики
</p>
<p className="list">
 - <span className="spanTag">startTime</span>: Первая записанная временная метка записи о производительности в миллисекундах (если применимо)
</p>
<p className="list">
 - <span className="spanTag">value</span>: Значение, или длительность в миллисекундах , в записи производительности
</p>
<p className="list">
 - <span className="spanTag">label</span>: Тип метрики ( web-vitalили custom)
</p>
...
Вы можете обрабатывать все результаты этих показателей с помощью web-vital метки:
...
<div className="note">
Примечание. Если вы используете Google Analytics, использование <span className="spanTag">id</span> значения может позволить вам создавать распределения показателей вручную (для расчета процентилей и т. Д.).
<Highlight language="javascript">
