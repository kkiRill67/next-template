...
Чтобы использовать перезапись, вы можете использовать <span className="spanTag">rewrites</span> ключ в next.config.js:
...
<span className="spanTag">rewrites</span> - это функция , которая ожидает асинхронной массив должен быть возвращен держа объекты с <span className="spanTag">source</span> и <span className="spanTag">destination</span> свойствами:
...
Допускаются совпадения путей, например <span className="spanTag">/blog/:slug</span> будет совпадение /blog/hello-world (без вложенных путей):
...
При использовании <span className="spanTag">basePath</span> поддержки с перезаписью каждый <span className="spanTag">source</span> и <span className="spanTag">destination</span> автоматически получает префикс, <span className="spanTag">basePath</span> если вы не добавите <span className="spanTag">basePath: false</span> в перезапись:
