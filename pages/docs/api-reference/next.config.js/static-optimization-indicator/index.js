...
В некоторых случаях этот индикатор может оказаться бесполезным, например, при работе с электронными приложениями. Чтобы удалить его, откройте next.config.js и отключите <span className="spanTag">autoPrerender</span> конфигурацию в <span className="spanTag">devIndicators</span>:
